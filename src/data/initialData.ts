...
export const INITIAL_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    longDescription: 'Desenvolvido sob medida para potencializar a produtividade corporativa, integrando funis de vendas, controle financeiro, emissão de relatórios gerenciais, cadastros unificados e automação de fluxos operacionais com alta segurança e escalabilidade.',
    category: 'Sistemas',
    imageUrl: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1200&auto=format&fit=crop',
    ...
    featured: false,
    metrics: [
      { label: 'Automação de processos', value: '85%' },
      { label: 'Visão operacional', value: '360°' },
      { label: 'Tempo de resposta', value: '< 200ms' },
    ],
    keyFeatures: [
      'Funil de vendas, pipeline de negociações e gestão completa de leads e clientes',
      'Módulos integrados de faturamento, contas a pagar/receber e fluxo de caixa',
      'Controle de estoque, compras, emissão de pedidos e relatórios gerenciais',
      'Controle de acessos baseado em funções (RBAC) e auditoria de atividades'
    ],
